...
class TradeCenter : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tradecneterrecycle.layoutManager = GridLayoutManager(this, 3) as RecyclerView.LayoutManager?
        ...
        val searchView = findViewById(R.id.search_trade_center) as MaterialSearchView
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        search_trade_center.setMenuItem(item)
        ...
        if (requestCode == MaterialSearchView.REQUEST_VOICE && resultCode == Activity.RESULT_OK) {
            ...
            if (matches != null && matches.size > 0) {
                ...
                if (!TextUtils.isEmpty(searchWrd)) {
                    search_trade_center.setQuery(searchWrd, false)
                }
            }
